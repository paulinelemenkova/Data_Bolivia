...
Having the efficient scripting algorithms in cartographic data processing of geospatial datasets can bring significant speed improvements to mapping process \cite{, , Lemenkova202203, }. Examples of such applications include applying the modules of GMT for specific cartographic tasks of data processing and visualisation. Effective processing of geospatial data by scripts is especially actual for large datasets which are the case for recent advances in Earth observation with global coverage \cite{LEI2020202,XIA2018245,NATIVI20151,WAGEMANN2021104916}. Console-based data processing using scripts enables to increase the accuracy and speed of data processing in cartographic analysis and plotting. Therefore, using advanced geospatial software and tools is also of major importance in many GIS-related applications that includes geospatial data processing, such as machine learning applications in GIS \cite{1607434,ARABAMERI2021100848,ZUO2021105111,SUN201926}, data retrieval, exploration and processing \cite{BUCK2022121,Lemenkova202140,1369823}, spatial data formatting and compression \cite{, , , }, geographic data modelling and analysis \cite{MA2021103858,Lemenkova202205,TAMIMINIA2020152}. 
