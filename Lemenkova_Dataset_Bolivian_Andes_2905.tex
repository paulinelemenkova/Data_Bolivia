...
\hl{The} Late Pleistocene glaciations also formed \hl{the} megafans of \hl{the} Gran Chaco -- a huge plain in eastern Bolivia and the main biogeographic biome of South America. Also\hl{, the} contrasting glaciation formed \hl{a series of} large piedmont fans of \hl{the} Andes that were developed during \hl{the} colder and seasonal conditions and dry–wet intense seasons and enhanced rainfalls by \hl{the} orographic effects of the Andes \cite{Latrubesse2009,Latrubesse2012}. \hl{A complex} interrelation of the vegetation, climate and soils can be illustrated by the reduced forest cover \hl{due to the} increased aridity in \hl{the} selected landscapes\hl{, }soil formation and intensive sedimentation in the \hl{dense} forest cover in the Bolivian Chaco \cite{May2008}. Besides glaciation, other external factors that strongly affected and shaped the topography of Bolivia include \hl{the} fluvial and aeolian interactions, climate and biogeographic effects. These mostly formed the Gran Chaco and \hl{selected} regions of Amazonia through \hl{the distribution of the} subtropical semi-deciduous vegetation \hl{and associated specific soil types in} the \hl{piedmonts of the} Andes.

The geomorphological patterns initially formed by the \hl{geological} processes are mirrored in fluvial belts, lacustrine patterns and riverine meanders \hl{in} Bolivia and \hl{shaped the} landscapes of the country \cite{Dumont}. \hl{The} landscapes in \hl{the} eastern Bolivia located along the southern margin of the Amazon basin are \hl{largely} affected by climate \hl{through the} strong hydrological and climatic seasonality, e.g.\hl{, }high wind speeds and aeolian processes. This affects the geomorphology and \hl{the} environment of \hl{the} eastern \hl{part of the country} forming special aeolian landforms\hl{, such as} linear sand streaks and ridges, parabolic and elongate morphological structures, dunes, sand sheets, mega-ripples. \hl{Hence}, climate and aeolian processes \hl{largely} control the environmental, vegetation and soil \hl{setting in the country} \cite{May2013}. 
...
The geologic maps (Figure~\ref{fig2} and Figure~\ref{fig3}) reflect the current state of the processes of solid Earth physics in the Andes. Thus, the metamorphic rocks and outcrops of various geologic epochs experienced solid-state mineral transformations due to changes in pressure and temperature in crust and mantle of the Earth, and record \hl{the} geological periods, heating, seismic processes and cooling that \hl{in turn} reflect the tectonic \hl{processes} they were formed \hl{in} \cite{Holder}. As a result, \hl{a} complex geological history of \hl{the} Bolivian Andes reflects its regional geology and petrographic setting, as well as the origin, distribution and \hl{the} geochemistry of \hl{the} minerals \cite{Tapia}. 

\hl{The} regional undulations of \hl{the} geoid (Figure~\ref{fig4}) well correlate with the topography of the country. \hl{For instance}, the values of geoid \hl{increase }westward exceeding 34 m, which well correlates with the geomorphology of the Central Andes. \hl{In general, the} isolines increase towards the west of Bolivia. In contrast, negative values of \hl{the} geoid (from 10 to -10) are visible in the NE region \hl{and} mostly cover the Amazon region of Brazil. The Beni Basin of Bolivia (Figure~\ref{fig3}) demonstrates \hl{a} slight decrease in data (from 20 to 16 m)\hl{,} while \hl{central} regions of the Madre dos Dios Basin \hl{show} local increase in \hl{the} geoid values (up to 32 m in the surroundings of the Madidi National Park).
...
\hl{The} comparison of \hl{the} geological map in Figure~\ref{fig2} with \hl{the} geoid model in Figure~\ref{fig4} \hl{shows a distinct correlation between those two}. The distribution of the geologic folds \hl{situated} westward off the Cambrian-Ordovician outcrops well repeats the dense and steep increase in \hl{the} isolines of the geoid detecting the increase of \hl{the} gravity that \hl{in turn} well correlates with the \hl{extent of the} mountain areas of the Andes (red \hl{colour} areas in Figure~\ref{fig4} shows values of geoid over 35 m). The correlation in changes of the free-air gravity (Figure~\ref{fig5}) and vertical gravity gradient (Figure~\ref{fig6}) with \hl{the topography} (Figure~\ref{fig1}) and \hl{geologic setting} (Figure~\ref{fig2}) are found by \hl{the comparison of} these maps, further from Andes to Amazonia area and the Gran Chaco region. In the inner western region of the Andes (Cordillera Occidental)\hl{,} a series of volcanoes are detected and mapped (Figure~\ref{fig7})\hl{ showing a certain} correspondence with \hl{a} higher magnitude of earthquakes \hl{(}M 3.4 to 4.0 and 4.1 to 4.7). 
...
The \hl{analysis of} values of the free-air gravity (Figure~\ref{fig5}) and vertical gravity (Figure~\ref{fig6}) demonstrates \hl{a} very good correlation with local lacustrine and riverine depressions of the mountainous lakes in Bolivia (Laguna Rogagua, Laguna San Luis), rivers of Amazonia, regional depression of \hl{the} Gran Chaco on the border with Paraguay, and the piedmonts of the Andes (dark blue \hl{colours} in Figures~\ref{fig5} and ~\ref{fig6}). In contrast, the highest elevation peaks of the Bolivian Andes (Cordillera Real, Cordillera Occidental and the Altiplano) well correlate with the highest values in \hl{the} geophysical data. The correlation of the gravity data with the geoid (Figure~\ref{fig4}) well \hl{exhibits} the lowest geoid values in the regions of the lower gravity in Figures~\ref{fig5} and ~\ref{fig6} and the saddle-like local depression in the region of the city La Santísima Trinidad (central Bolivia) showing local topographic depression. 

The overall distribution of the earthquakes in Bolivia (Figure~\ref{fig7}) \hl{indicate} a good correlation with \hl{the geological} extent of the Cordillera Occidental, followed by the Altiplano and the Cordillera Real. In total, 3,000 records have been assessed using \hl{the} IRIS database for \hl{the period of} 2015-2021. In general, the higher seismicity level of Bolivia is clearly visible in the westernmost region of the country. The earthquake with the least \hl{a moment} magnitude (1.8) is detected 17 km ESE of \hl{the} Iquique, Chile, at \hl{the depths of} 20 km. In contrast, the most significant, very deep earthquake events are located 211 km S of Tarauaca, Brazil (620.6 km, \hl{moment}magnitude 7.6), and at 173 km WNW of Iberia, Peru with the depth of 606.2 km.

The most significant earthquake \hl{in} Bolivia is located 11 km NNE of Carandayti with \hl{a} depth of 559 km and \hl{a moment} magnitude of 6.8. Also, some significant earthquakes within the strongest magnitude (above 7) are located in Peru: 1) 140 km WNW of Iberia, Peru which took place in 2018 with \hl{a moment} magnitude of 7.1 at \hl{the} depth of 630 km; 2) 38 km SSW of Acari, Peru, also dated of 2018, with \hl{a moment} magnitude of 7.1 located at \hl{the} depth of 39 km (shallow earthquake). Thus, one can conclude that the most significant earthquake during the last 6 years (2015-2021) \hl{in} Bolivia did not exceed \hl{the moment} magnitude of 7.0, which indicates a \hl{rather} lower seismic activity in Bolivia and less risk to \hl{the} population\hl{, if compared, for example,} to Peru. 

\section{Discussion}

Using scripting techniques of GMT has many applications in geosciences. For example, \hl{analysis of the} geologic setting of the Earth, climate modelling, exploring the atmosphere-ocean-solid earth interactions \hl{which require} advanced mapping, and many more. Rapid processing of maps by GMT enables to produce a series of maps, which is a crucial source of geo-information for such tasks. To fully utilise the potential of GMT, the abilities and advantages of \hl{the} modern scripting approaches should be used. In this research I demonstrated the functionality of GMT and QGIS for \hl{the} thematic mapping of Andes region \hl{using} the geological and geophysical datasets \hl{available from the open sources}. Currently\hl{, the} geo-information data are available online in many sources which increase the need for rapid and robust processing of these data, based on \hl{the} availability. 
...
\hl{Mapping} multi-source geo-information data is based on \hl{the} processing and visualising \hl{of} relevant thematic layers showing geological and geophysical features of the target objects\hl{, such as} free-air gravity anomalies, vertical gravity gradients, earthquakes and other concepts. The major principle of \hl{the} GMT \hl{consists in} creating the \hl{lines} of code based on \hl{its} syntax language. For instance, I set up experimentally the projection and selected colour palettes for each corresponding \hl{geographic} phenomena to better show the variations in levels\hl{. Such adjustments enabled to better} indicate the correlations between the topography and geophysics of the Andes region\hl{. Moreover, the integrated use of the techniques of }QGIS and GMT \hl{was used} to identify the relationships between the geological and geophysical phenomena of the Earth through the prepared maps. Based on the setup parameters of GMT, the \hl{a }series of maps \hl{was mapped using machine-based approach} using scripts run from the console\hl{. A }step-by-step cartographic process applied for the presented maps \hl{is shown in the scripts available in the GitHub repository with provided link}.

This workflow arrived at \hl{the} data processing and visualisation on the presented series of maps \hl{showing} geologic, \hl{geophysical} and topographic \hl{features} of Bolivia. However, certain steps in \hl{a} cartographic workflow required manual adjusting and improvements in \hl{the} QGIS compared to \hl{the} GMT, which demonstrated a higher level of automation in \hl{spatial} data processing \hl{of the latter}. The most geologically complicated regions (folds in the Bolivian Andes) were mapped using \hl{the} enlarged zoom, to gain more insights \hl{into} the visual characteristics of the small areas (\hl{e.g.,}see the Devonian and Ordovician outcrops in Figure~\ref{fig2}), \hl{as well as} to discriminate the strata from the undifferentiated areas. To do so, I \hl{enlarged the} selected areas on the map\hl{ }and controlled \hl{the} visualisation manually using a zoom function of QGIS. Specifically, I identified \hl{the} densely interspersed outcrops of \hl{the} Cretaceous-Tertiary volcanics (Cv), Precambrian-Devonian (AD) and \hl{Palaeozoic} (PZ) units\hl{ }in the Bolivian Andes, which demonstrated a \hl{distinct} correlation \hl{between the} gravity anomaly and \hl{the} topographic heights \hl{of} the same territory. 

This study presented an integrated application of the GMT scripting toolset and \hl{the} QGIS software \hl{used} for mapping geological and geophysical \hl{features} of Bolivia in a semi-automatic regime \hl{in} GMT and \hl{a} manual \hl{approach in the} QGIS. I noted that while using a reliable software tool is a major task of any cartographic \hl{workflow}, there are still more algorithms that need to be \hl{adjusted} in GMT for a more automated cartographic workflow\hl{. }Processing geo-information\hl{ is} an essential part of geophysical and geological research having its specifics compared to the topographic or environmental mapping: \hl{the} interpretation of \hl{the} geophysical anomalous fields, visualising seismic events as \hl{a series of} earthquakes \hl{with different magnitude, and depth, detecting} geoid undulations \hl{using} isoline directions and interpretation, smooth data conversion from \hl{the} seismic IRIS catalogue into GMT, \hl{to mention a few of such tasks. This paper presented an example of such study showing the integrated use of the GMT and QGIS for processing the} geological, topographic and geophysical data\hl{ with a special example of Bolivia, South America.} 

\section{Conclusion}

In this study, a \hl{data-driven} cartographic approach for data processing has been presented using an example of scripting techniques of GMT applied for raster-based data and \hl{ }GIS-based mapping for vector data. By exploring \hl{the} principles of \hl{the} console-based mapping in \hl{GMT, }this study \hl{visualised and evaluated} the geophysical parameters that capture the intrinsic geologic properties of the Bolivian Andes\hl{, as demonstrated through} the existing links \hl{on} a series of maps. The study also \hl{used} the modular technique of GMT to increase the speed, accuracy and effectiveness of mapping. \hl{The cartography as an important disciplines among the} Earth sciences experienced \hl{technical advances with the development of programming}. \hl{New methods used for}  spatial data processing\hl{ enabled a more effective processing of the complex datasets for modelling the Earth} \cite{Bar,LOMBARDO,Lemenkova2020e}. \hl{This enabled to get} new insights into the correlations between the Earth phenomena\hl{. This increased the possibilities of the traditional }GIS \hl{used for mapping} spatial data \cite{Millington,Lemenkova202137}. 	

\hl{The} GIS-based mapping is used for integrated thematic maps\hl{ }or in risk assessment studies \cite{Vella,Lemenkova202120}. \hl{The }geological GIS-based mapping \hl{is} largely supported by visualisation of the provinces and units \cite{Nedel}, statistical graphs and plotting for hydrocarbon resource analysis \cite{Jemio}. Other approaches include geophysical \hl{and geochemical data} analysis \cite{Collinson,Lindh2022,Ocola} or gravimetric geoid modelling \cite{Corchete}. \hl{The existing} GIS applications \hl{of} mapping Bolivia are presented in studies of \hl{the} ecosystem services combining quantitative and qualitative data and spatial GIS \hl{to} assess \hl{the} environmental changes \cite{Hinojosa}. In contrast to \hl{the} thematic applications of GIS \hl{specifically for} Bolivia, using scripting techniques \hl{is} presented \hl{as a special opportunity} of \hl{the machine-based} cartography. Specifically, scripting approach causes advantages \hl{in Earth studies in geological, geophysical and geotechnical modelling of soil data, seismic analysis and simulation, risk mitigation and vulnerability assessment} \cite{Falcone,Lindh2021b,Chang,Fayjaloun,Petersen}. \hl{The advantages of scripts can be explained by} the increased speed of \hl{data processing}, accurate \hl{plotting} and machine-based \hl{workflow} routine that \hl{significantly} minimises the man-made errors and misprints. These include such improvements as automated mapping, precise \hl{data handling} automated re-projecting\hl{, }or processing \hl{big} data.

This paper contributes to the \hl{increase} of \hl{the} geographic knowledge of Bolivia by \hl{presenting the} an integrated framework \hl{of} the geological, topographic, seismic and geophysical data \hl{processing} by means of \hl{the} GIS and a GMT\hl{. }Specifically, it demonstrated that using scripts enables to meet \hl{the} high demands of \hl{the} contemporary cartography, e.g.\hl{,} spatial \hl{analysis, computing and} visualisation of \hl{the} multi-format data for \hl{an integrated} analysis. \hl{A }structured analysis of the \hl{data} has been performed to incorporate \hl{the} insights \hl{into} the geologic \hl{analysis using} regional characteristics of lithology and geological provinces and basins of Bolivia\hl{, a special unique region of the Central Andes, South America}.
