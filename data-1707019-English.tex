...
\Author{\hl{Polina Lemenkova} \hl{\orcidA{}} %MDPI: Please confirm Orcid number.
}%MDPI: 
% \dagger,\ddagger
%\longauthorlist{yes}
...
\address[1]{%
\hl{Universit\'e Libre de Bruxelles, \'Ecole Polytechnique de Bruxelles (EPB, Brussels Faculty of Engineering), Laboratory of Image Synthesis and Analysis}%MDPI: Please confirm order and units in affiliation, please confirm brackets (check if Faculty should be outside of brackets) and please check if each unit could be in English language.
, \hl{Building L, Campus de Solbosch CP131/3, Avenue Franklin D. Roosevelt 50}%MDPI: Please check if these information (building, campus and street information) are necessary, if not, please remove them.
, B-1050 Brussels, Belgium; polina.lemenkova@ulb.be or \hl{pauline.lemenkova@gmail.com}%MDPI: Please confirm second e-mail.
; \linebreak Tel.: +32-47-186-0459}
...
\begin{figure}[H]
	...
	\caption{\hl{Topographic} %MDPI: Figure moved after its first ctiation. Please confirm.
 map of the study area. Visualisation: GMT. Source: author.\label{fig1}}
\end{figure} 
...
\textls[-20]{The current study {aimed} to identify the distribution and magnitude of earthquakes in the Bolivian Andes in the context of the geologic, geophysical, and topographic situation. The study {was} performed using the technical integration of QGIS and GMT scripting tools {applied} to {Bolivia. The} topographic elevation data, geologic provinces and units, {as well as} seismic events obtained from the IRIS database {were mapped}. The five full scripts used in this study for mapping {(}\hl{Figures} %MDPI: Figures 4-7 are cited before Figures 2 and 3, please check if this should be invalid citation or move Figures 4-7 below this paraghraph and revise each figure citation.
~\ref{fig1} and~\ref{fig4}--\ref{fig7}{)} are available in the GitHub repository of the author with public open-access}: \url{https://github.com/paulinelemenkova/Mapping\_Bolivia\_GMT\_Scripts} \hl{(accessed on)}%MDPI Please add accessed date if needed.
.

The topographic map (\hl{Figures} %MDPI: Figure 7 is cited before Figures 2-6, please check if this should be invalid citation or move Figure 7 below this paraghraph and revise each figure citation.
~\ref{fig1} and \ref{fig7}) was mapped as a background {for the} IRIS seismic data. {It was derived} from {the} General Bathymetric Chart of the Oceans (GEBCO) gridded bathymetry and topography dataset \cite{Schenke2016}. {The} GEBCO presents consistent and accurate digital elevation data covering the Earth{,} largely used in {the} Earth sciences {as a} reliable data source. The unprecedentedly high resolution (15 arc second) of {the} GEBCO grid enables using it as a fine cartographic grid both for topographic mapping and as a background for {the} overlaying thematic maps \cite{Lemenkova2020b}{.} 
...
\begin{figure}[H]
	...
	\caption{\hl{Geologic} %MDPI: Figure moved after its first ctiation + 1 paraghraph (because of blank space). Please confirm.
...
\funding{\hl{ } %MDPI: Please add this section.
}%Please add: ``This research received no external funding'' or ``This research was funded by NAME OF FUNDER grant number XXX.'' and and ``The APC was funded by XXX''. Check carefully that the details given are accurate and use the standard spelling of funding agency names at \url{https://search.crossref.org/funding}, any errors may affect your future funding.}

\institutionalreview{\hl{ } %MDPI: Please add this section. If there should be one.
...
\informedconsent{\hl{ } %MDPI: Please add this section. If there should be one.
...
\dataavailability{The GitHub repository of the author with available GMT scripts: \url{https://github.com/paulinelemenkova/Mapping\_Bolivia\_GMT\_Scripts} (\hl{accessed on}%MDPI: Please add accessed date if necessary.
).} 

\acknowledgments{The author thanks the Reviewers and Editor for the review and \hl{editing} %MDPI: Please check if this is for English editing.
 of this manuscript.}
...
\noindent 
\begin{tabular}{@{}ll}
CSV & \hl{Comma-Separated Values} %MDPI: Please check if these words should be capitalized as others below.
 \\
...
\newblock In \hl{Proceedings} %MDPI: Please confirm added location and date for Proceedings.
...
\newblock In \hl{Proceedings} %MDPI: Please confirm added location and date for Proceedings.
 of the IGARSS 2004---2004 IEEE International Geoscience
 and Remote Sensing Symposium, Anchorage, AK, USA, 20--24 September 2004; Volume 4, pp. 2575--2578. https://doi.org/10.1109/IGARSS.2004.1369823.
...
\bibitem[Allenby(1987)]{ALLENBY1987137}
\hl{Allenby, R.J.} %MDPI: Please check duplicated reference [27] and [47]. 
...
\newblock Review of the SBAS InSAR Time-series algorithms, applications, and
 challenges.
\newblock {\em Geod. Geodyn.} {\bf 2022}, {\em 13},~114--126. https://doi.org/10.1016/j.geog.2021.09.007. \hl{Advances in InSAR algorithms, deformation monitoring and source parameter inversion.} %MDPI: Please confirm that this could be removed.
...
\newblock {\em Procedia Environ. Sci.} {\bf 2016}, {\em 32},~244--255. https://doi.org/10.1016/j.proenv.2016.03.029. \hl{ECOSMART---Environment at Crossroads: Smart Approaches for a Sustainable Development.} %MDPI: Please confirm that this could be removed.
...
\newblock In \hl{Proceedings} %Please confirm added location and date for Proceedings.
 of the 2019 International Conference on ENERGY and
...
\newblock Land suitability assessment for rice crop using geospatial
 techniques.
\newblock In \hl{Proceedings} %MDPI: Please confirm added location and date for Proceedings.
 of the 2013 IEEE International Geoscience and Remote
...
\newblock Utilizing Historic Cartography in 3D for Archaeological Prospection
 on Alcatraz. In \hl{Proceedings} %Please confirm added location and date for Proceedings.
 of the 2018 3rd Digital Heritage International
 Congress (DigitalHERITAGE) Held Jointly with 2018 24th International
 Conference on Virtual Systems Multimedia (VSMM 2018), San Francisco, CA, USA, 26--30 October 2018; pp. 1--4.
...
\newblock {\em Procedia Eng.} {\bf 2012}, {\em 29},~1331--1337. https://doi.org/10.1016/j.proeng.2012.01.136. \hl{2012 International Workshop on Information and Electronics Engineering.} %MDPI: Please confirm that this could be removed.
...
\newblock Disguise and Reduction Methods of GIS Vector Data Based on Difference
 Expansion Principle.
\newblock {\em Procedia Eng.} {\bf 2012}, {\em 29},~1344--1350. https://doi.org/10.1016/j.proeng.2012.01.138. \hl{2012 International Workshop on Information and Electronics Engineering.} %MDPI: Please confirm that this could be removed.
...
\newblock In {\em {Encyclopedia of Marine Geosciences}}, 1st ed.; \hl{Encyclopedia
 of Earth Sciences}%MDPI: Please confirm that this could be removed.
...
Association, Q. QGIS Geographic Information System. 2021. \hl{Available online: (accessed on)} %MDPI: Please confirm web type reference, please confirm author name.
.
...
Suárez~Soruco, R. \emph{Compendio de Geología de Bolivia}; Revista Técnica de Yacimientos Petrolíferos Fiscales Bolivianos: Cochabamba, Bolivia, 2000; Volume 18. \hl{no. 1-2. ll, maps; 28 cm, 4 folded maps.} %MDPI: Please confirm that this could be removed.
...
Zhu, L.
\newblock Recovering permanent displacements from seismic records of the June
 9, 1994 Bolivia deep earthquake.
\newblock {\em Geophys. Res. Lett.} {\bf \hl{2003}%MDPI: Please add pagination/article number if there is one.
}, {\em 30}. https://doi.org/10.1029/2003GL017302.
...
\newblock In {\em {Developments in Quaternary Sciences}}; Elsevier: \hl{Amsterdam, The Netherlands,} %newly added information, please confirm
2004; Volume 2, Chapter {Part C}, pp. 83--88.
...
\newblock In {\em {Quaternary Glaciations---Extent and Chronology: A Closer
 Look}}; Elsevier: Amsterdam, The Netherlands, 2011; Volume 15, \hl{\emph{Developments
 in Quaternary Sciences}, Chapter 56, pp. 773--802.} %MDPI: Please confirm that this should be removed or check if it is part of some other reference.
...
Jemio, L.C. \emph{Booms and Collapses of the Hydro Carbons Sector in Bolivia}; \hl{Technical Report; Development Research Working Paper Series 09/2008}%MDPI: Please confirm if this should be removed.
; Institute for Advanced Development Studies: La Paz, Bolivia, 2008.
